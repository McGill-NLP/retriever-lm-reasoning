        ...
        if not self.is_client:
            try:
                self.model = AutoModelForSeq2SeqLM.from_pretrained(
                    ...
                    cache_dir="/network/scratch/p/parishad.behnamghader/.cache/"
                )
            ...
            self.tokenizer = AutoTokenizer.from_pretrained(model, cache_dir="/network/scratch/p/parishad.behnamghader/.cache/")
        self.history = []
