...
class Options:
    ...
    def add_modeling_options(self):
        ...
        self.parser.add_argument(
            "--qa_answer_format",
            type=str,
            default="<extra_id_0> {target}",
            help="How to format answer as input prompts when using --task qa",
        )

        self.parser.add_argument(
            "--lm_question_mask_token",
            type=str,
            default="<extra_id_0>",
            help="the masking token e.g., [MASK], <extra_id_0>, etc.",
        )
