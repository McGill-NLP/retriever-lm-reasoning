...
from . import base, fever, kilt, lm, mlm, multiple_choice, qa, section, my_lm

AVAILABLE_TASKS = {m.__name__.split(".")[-1]: m for m in [base, mlm, lm, multiple_choice, kilt, section, fever, qa, my_lm]}
