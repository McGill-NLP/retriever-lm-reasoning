...
def main(parsed_args):
    ...
    with progress_bar.build_progress_bar(args, itr) as t:
        ...
        # print(dstore_keys.shape, dstore_vals.shape)
        ...
        for ex_i, sample in enumerate(t):
            ...
            # print('hypos')  # , len(hypos), hypos)
            # for h in hypos:
            #     h = h[0]
            #     print(h['tokens'].shape, h['tokens'][-10:], h['dstore_keys'].shape, h['dstore_keys'])
            #     # print(" ".join([task.source_dictionary[t.item()] for t in h['tokens']]))
            #     print("-----------")
            # return
            for i, hypos_i in enumerate(hypos):
                ...
                # print([task.source_dictionary[tokens[i].item()] for i in range(10)])
                # return
