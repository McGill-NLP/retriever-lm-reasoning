...
class RealmRetriever:
    ...
    def __call__(self, retrieved_block_ids, question_input_ids, answer_ids, max_length=None, return_tensors="pt"):
        ...
        if len(retrieved_block_ids.shape) == 0:
            retrieved_block_ids = retrieved_block_ids.unsqueeze(0)
        ...
        text = []
        text_pair = []
        # print(self.block_records, '\n', retrieved_blocks)  # TODO Parishad
        ...
        # print(concat_inputs_tensors.input_ids)  # TODO Parishad
